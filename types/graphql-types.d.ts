...
export type Site_Index_QueryQueryVariables = Exact<{ [key: string]: never; }>;


export type Site_Index_QueryQuery = { allMdx: { nodes: Array<(
      Pick<Mdx, 'id' | 'excerpt'>
      & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date'>>, fields?: Maybe<Pick<MdxFields, 'slug'>> }
    )> } };
